...
androidAbout.onclick=()=>{
 ...
 androidPanel.hidden=false;
 androidPanel.innerHTML='<div class="android-about">DayFlow v0.8-m31</div>';
};
...
async function getPushSubscription(){
 ...
 const registration=await navigator.serviceWorker.register('service-worker.js?v=0.8-m31');
